...
import { FaBolt } from "react-icons/fa"; // İkon için react-icons kullandım
    ...
    <div className="w-full max-w-95 bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sticky top-24">
      ...
      <div className="space-y-3">
        <div className="flex justify-between text-gray-600 text-base">
          <span className="underline decoration-gray-300 cursor-pointer hover:text-gray-900">$450 x 5 nights</span>
          <span>$2,250</span>
        </div>
        <div className="flex justify-between text-gray-600 text-base">
      ...
      <div className="flex justify-between items-center mt-6 pt-6 border-t border-gray-200">
        ...
        <span className="text-xl font-bold text-gray-900">$2,420</span>
      </div>
